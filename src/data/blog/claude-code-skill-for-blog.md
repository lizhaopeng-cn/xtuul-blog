---
author: Xtuul
pubDatetime: 2026-04-23T18:47:43+08:00
...
这是"从零搭建个人技术博客"系列的第三篇。**篇二（跨平台自动分发）先欠着**，因为这几天实际写文章时发现一个更前置的麻烦 —— 写/改/删一篇博客的操作太零碎了，想先把它自动化掉。
...
篇二（跨平台分发）还是会写，放到 `/blog new` 也能用上了 —— 自动化工具先用自动化工具写出来，有点递归但很顺。
